...
#define trillianInitialize( structure )                                                            \
  do {                                                                                             \
...
#define trillianListInitialize( structure )                                                        \
  do {                                                                                             \
    ...
    structure.font.hover_background    = structure.font.hover_foreground =                         \
      structure.font.select_background = structure.font.select_foreground =                        \
...
// spaces separate words.  so if you want to search for anything with bob and tom in it, search for
// "bob tom"
struct message_search_t {
  ...
  int   name_fullmatch;
  char *name; // depending on the type of message, the name field may match different things..ie:
              // status changes, name will be the 'who' field, but otherwise it could be the to or
              // the from field.
  char *location;
